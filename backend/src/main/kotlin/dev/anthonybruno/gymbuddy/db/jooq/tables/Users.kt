...
import dev.anthonybruno.gymbuddy.db.jooq.indexes.IDX_USER_EMAIL
import dev.anthonybruno.gymbuddy.db.jooq.keys.USERS_EMAIL_KEY
import dev.anthonybruno.gymbuddy.db.jooq.keys.USERS_PKEY
...
class Users(
     ...
     */
    val EMAIL: TableField<UsersRecord, String?> = createField(DSL.name("email"), SQLDataType.VARCHAR(150).nullable(false), this, "")
     ...
     */
    val TIMEZONE: TableField<UsersRecord, String?> = createField(DSL.name("timezone"), SQLDataType.CLOB.nullable(false).defaultValue(DSL.field("'Australia/Adelaide'::text", SQLDataType.CLOB)), this, "")
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_USER_EMAIL)
