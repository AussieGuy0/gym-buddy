...
export const WorkoutForm: React.FC<WorkoutFormProps> = ({ workoutAdded }) => {
  ...
  function upsertExercise(
    idx: number,
    updatedWorkoutExercise: WorkoutExercise
  ) {
    if (idx === -1) {
    ...
    <div>
      <form>
        ...
        <div className="mb-3">
          ...
          {workoutExercises.length === 0 && !editingExercise && (
            <div className="text-secondary">
              No exercises have been added to the workout :({' '}
            </div>
          )}
          ...
          {editingExercise && editingExerciseIndex != null && (
            <ExerciseFormItem
              ...
              upsertExercise={(updated) =>
                upsertExercise(editingExerciseIndex, updated)
              }
        ...
        <button
          ...
          disabled={
            loading || editingExercise != null || workoutExercises.length === 0
          }
      ...
      <div className="row mt-2">
        <div className="col">
          <button
            ...
            type="button"
            disabled={!isValid()}
            onClick={() => upsertExercise(workoutExercise)}
          >
            Add
          </button>
